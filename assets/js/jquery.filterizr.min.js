! function(t, i) {
    ...
    r.prototype = {
        init: function(t) { this.root = { x: 0, y: 0, w: t } },
        fit: function(t) {
        ...
        findNode: function(t, i, r) { return t.used ? this.findNode(t.right, i, r) || this.findNode(t.down, i, r) : i <= t.w && r <= t.h ? t : null },
        splitNode: function(t, i, r) { return t.used = !0, t.down = { x: t.x, y: t.y + r, w: t.w, h: t.h - r }, t.right = { x: t.x + i, y: t.y, w: t.w - i, h: r }, t },
        growDown: function(t, i) { var r; return this.root = { used: !0, x: 0, y: 0, w: this.root.w, h: this.root.h + i, down: { x: 0, y: this.root.h, w: this.root.w, h: i }, right: this.root }, (r = this.findNode(this.root, t, i)) ? this.splitNode(r, t, i) : null }
            ...
            for (var t = this, i = [], r = {}, e = 0; e < t._mainArray.length; e++) {
                ...
                if (Array.isArray(n._category)) {
                    for (var s = 0; s < n._category.length; s++)
                        if (n._category[s] in t._toggledCategories) { o = !0; break }
        ...
        _calcItemPositions: function() {
            ...
            if ("packed" === t.options.layout) {
                i.each(t._activeArray, function(t, i) { i._updateDimensions() });
                var h = new r(t.outerWidth());
                for (h.fit(t._activeArray), c = 0; c < e.length; c++) _.push({ left: e[c].fit.x, top: e[c].fit.y });
                n = h.root.h
            }
            if ("horizontal" === t.options.layout)
                for (a = 1, c = 1; c <= e.length; c++) s = e[c - 1].outerWidth(), l = e[c - 1].outerHeight(), _.push({ left: f, top: u }), f += s, l > n && (n = l);
            else if ("vertical" === t.options.layout) {
                for (c = 1; c <= e.length; c++) l = e[c - 1].outerHeight(), _.push({ left: f, top: u }), u += l;
                n = u
                ...
                for (c = 1; c <= e.length; c++) {
                    ...
                    var p = e[c - 1].outerWidth(),
                        y = 0;
                    e[c] && (y = e[c].width()), _.push({ left: f, top: u }), g = f + s + y, g > d ? (g = 0, f = 0, u += e[0].outerHeight(), a++) : f += p
                }
                n = a * e[0].outerHeight()
            } else if ("sameWidth" === t.options.layout) {
                for (c = 1; c <= e.length; c++) {
                    if (_.push({ left: f, top: u }), c % o === 0 && a++, f += s, u = 0, a > 0)
                ...
                for (c = 1; c <= e.length; c++) _.push({ left: f, top: u }), f += s, c % o === 0 && (u += e[0].outerHeight(), f = 0);
        ...
        _multifilterModeOn: function() { var t = this; return Object.keys(t._toggledCategories).length > 0 },
        _isSearchActivated: function() { var t = this; return t._typedText.length > 0 },
        ...
        _getCollectionByFilter: function(t) { var i = this; return "all" === t ? i._mainArray : i._subArrays[t - 1] },
        _makeDeepCopy: function(t) { var i = {}; for (var r in t) i[r] = t[r]; return i },
        _comparator: function(t, i) { return function(r, e) { return "asc" === i ? r[t] < e[t] ? -1 : r[t] > e[t] ? 1 : 0 : "desc" === i ? e[t] < r[t] ? -1 : e[t] > r[t] ? 1 : 0 : void 0 } },
        ...
        _fisherYatesShuffle: function(t) { for (var i, r, e = t.length; e;) r = Math.floor(Math.random() * e--), i = t[e], t[e] = t[r], t[r] = i; return t }
    };
    var e = {
        _init: function(t, i) { var r = this; return r._parent = i, r._category = r._getCategory(), r._lastPos = {}, r.domIndex = t, r.sortData = r.data("sort"), r.w = 0, r.h = 0, r._isFilteredOut = !0, r._filteringOut = !1, r._filteringIn = !1, r.css(i.options.filterOutCss).css({ "-webkit-backface-visibility": "hidden", perspective: "1000px", "-webkit-perspective": "1000px", "-webkit-transform-style": "preserve-3d", position: "absolute", transition: "all " + i.options.animationDuration + "s " + i.options.easing + " " + r._calcDelay() + "ms" }), r.on("transitionend webkitTransitionEnd oTransitionEnd MSTransitionEnd", function() { r._onTransitionEnd() }), r },
